...
\item Abstraction
  ...
  \item In the application implementation process, there is always more than one way to achieve the goal, like the sorting algorithm used or the data structure used. The programmer has the flexibity to choose the best one to use. The implementation will surely use the built-in data types and their respective methods. The programmer doesn't need to know under the hood details of how they were implemented, they just need to know that it does the specified task.
  \end{itemize}
